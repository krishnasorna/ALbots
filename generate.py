...
def Generate_Brain():
    ...
    # pyrosim.Send_Synapse(sourceNeuronName=0, targetNeuronName=3, weight=50.0)
    # pyrosim.Send_Synapse(sourceNeuronName=1, targetNeuronName=3, weight=50.0)
    # pyrosim.Send_Synapse(sourceNeuronName=0, targetNeuronName=4, weight=50.0)
